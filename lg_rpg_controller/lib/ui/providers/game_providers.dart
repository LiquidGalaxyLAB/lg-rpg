...
final activatePowerupUseCaseProvider = Provider<ActivatePowerupUseCase>((ref) {
  return ActivatePowerupUseCase(ref.watch(gameServerRepositoryProvider));
});

final selectCharacterUseCaseProvider = Provider<SelectCharacterUseCase>((ref) {
  return SelectCharacterUseCase(ref.watch(gameServerRepositoryProvider));
});

final setLoadoutUseCaseProvider = Provider<SetLoadoutUseCase>((ref) {
  return SetLoadoutUseCase(ref.watch(gameServerRepositoryProvider));
});
...
/// Currently selected character id, shared across the UI.
final selectedCharacterProvider = StateProvider<String>(
  (ref) => ref.watch(gameServerRepositoryProvider).selectedCharacter,
);
